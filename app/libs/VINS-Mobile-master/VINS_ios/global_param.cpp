...
bool setGlobalParam(DeviceType device)
{
    switch (device) {
        ...
        case GalaxyS7:
            ...
            FOCUS_LENGTH_X = 510.131;
            FOCUS_LENGTH_Y = 510.131;
            PX = 320;
            PY = 240;
...
//original
        ...
        case GooglePixel2:
            printf("Device Google Pixel2 param\n");
            FOCUS_LENGTH_X = 518.1325;
            FOCUS_LENGTH_Y = 518.1325;
            PX = 239.5;
            PY = 319.5;
        ...
        case LGG6:
            printf("Device LG G6 param\n");
            FOCUS_LENGTH_X = 575.9494;
            FOCUS_LENGTH_Y = 575.9494;
            PX = 239.5;
            PY = 319.5;
