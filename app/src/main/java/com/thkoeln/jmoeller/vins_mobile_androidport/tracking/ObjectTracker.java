...
import com.thkoeln.jmoeller.vins_mobile_androidport.env.Size;
...
public class ObjectTracker {
    ...
    static {
        try {
            ...
            libraryFound = true;
            LOGGER.i("libtensorflow_demo.so found");
    ...
    public static synchronized ObjectTracker getInstance(
        ...
        LOGGER.i("ObjectTracker getInstance");
        if (!libraryFound) {
            LOGGER.e(
            ...
            LOGGER.i("Native object tracking found");
        }
    ...
    public synchronized void nextFrame(
        ...
        for (final TrackedObject trackedObject : trackedObjects.values()) {
            LOGGER.i("Tracked object: %s", trackedObject.getTrackedPositionInPreviewFrame());
